...
parser.add_argument('-t', '--theme', dest='theme_file', type=str, 
        nargs='+', 
        help='(Show message to you at specified time.)')
...
if __name__== '__main__':
    ...
    md_file = MakeFile(user_meassage, config, template_tags) 
    md_file.file_write()

    if args.theme_file:
        user_theme_file = "".join(args.theme_file)
        theme_file_md = MakeThemeFile(user_meassage, config, template_tags, user_theme_file)
